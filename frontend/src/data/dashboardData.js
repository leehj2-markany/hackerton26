...
export const caseHistory = [
  ...
  { id: 'C-004', customer: '국민건강보험공단', product: 'Safe PC', question: '대량 배포 시 성능 이슈', resolvedBy: 'human', responseTime: 960, satisfaction: 4, date: '2026-02-27', agent: '이현진' },
  { id: 'C-005', customer: 'SK하이닉스', product: 'DRM', question: 'API 연동 가이드 요청', resolvedBy: 'ai', responseTime: 8, satisfaction: 4, date: '2026-02-26' },
  { id: 'C-006', customer: '현대자동차', product: 'Screen SAFER', question: '클라우드 환경 지원 여부', resolvedBy: 'ai', responseTime: 5, satisfaction: 5, date: '2026-02-26' },
  ...
  { id: 'C-010', customer: '국민건강보험공단', product: 'Safe PC', question: '출력물 보안 정책 설정 방법', resolvedBy: 'ai', responseTime: 9, satisfaction: 4, date: '2026-02-24' },
  ...
  { id: 'C-013', customer: '현대자동차', product: 'Screen SAFER', question: '동영상 DRM 적용 가능 여부', resolvedBy: 'ai', responseTime: 6, satisfaction: 4, date: '2026-02-22' },
  ...
  { id: 'C-017', customer: '국민건강보험공단', product: 'Safe PC', question: '감사 로그 조회 기능', resolvedBy: 'ai', responseTime: 5, satisfaction: 4, date: '2026-02-20' },
...
export const productAIvsHuman = [
  ...
  { name: 'Screen SAFER', total: 150, ai: 80, human: 70, aiRate: 53, color: '#10B981' },
  { name: 'Safe PC', total: 80, ai: 55, human: 25, aiRate: 69, color: '#F59E0B' },
  { name: 'e-Page SAFER', total: 70, ai: 25, human: 45, aiRate: 36, color: '#8B5CF6' }
]
...
export const recentEvents = [
  ...
  { time: '14:29:55', type: 'ai', event: '현대자동차 — Screen SAFER 클라우드 지원 자동 해결 (5.1초)', icon: '🤖' },
